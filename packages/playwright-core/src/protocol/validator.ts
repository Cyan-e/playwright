...
scheme.BrowserTypeLaunchPersistentContextParams = tObject({
  ...
  navigator: tOptional(tObject({
    platform: tString,
    userAgentData: tOptional(tObject({
      brands: tOptional(tArray(tObject({
        brand: tString,
        version: tString,
      }))),
      architecture: tOptional(tString),
      bitness: tOptional(tString),
      model: tOptional(tString),
      wow64: tOptional(tBoolean),
      platformVersion: tOptional(tString),
